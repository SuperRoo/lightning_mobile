...
Ext.define('Mob2.controller.Details', {
    ...
    onLstAttachmentsItemSingletap: function(dataview, index, target, record, e, eOpts) {
        var me = this;
        if(record){
            window.plugins.fileOpener.open("file:///storage/sdcard0/lightning/attachments/theFile.pdf");
        }
    },
    ...
    onCmdAttachmentAddTap: function(button, e, eOpts) {
        if(Ext.os.deviceType !== 'Desktop'){
            if(window.innerWidth < window.innerHeight){
                Ext.Msg.alert('Lightning','you can only take pictures in landscape...<br>turn your device');
            }else{
                        ...
                        function(entry){
                            ...
                            function(fileSys) {
                                ...
                                function(directory){
                                    ...
                                    var newName = me.generateUUID() + '.jpg'
                                    entry.moveTo(directory, newName,
                                    function(newEntry){
                                        //add to store
                                        me.attachmentAdd(newName);
                                    },
                                    function(error){
    ...
    attachmentAdd: function(fileName) {
